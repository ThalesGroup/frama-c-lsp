...
curl -v -H "Content-Type:application/json" -POST http://localhost:8001 -d '{"jsonrpc": 2.0, "id": 1, "method": "textDocument/definition", "params":{"textDocument":{"uri": "/home/user/git/L1/T0304764/acsl_lsp/Acsl_lsp/server/tests/math.h"}, "position": {"line": 1522, "character": 30}}}'
