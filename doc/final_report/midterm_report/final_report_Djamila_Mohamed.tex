...
To install the plug-in you will need the following: opam, frama-c 28.0
\begin{enumerate}
...
Since the extension is not published, you can install it locally on your VS Code.
...
\begin{itemize}
	...
	\item vsce
\end{itemize}
If you need to recompile the client, perform these additional steps before:
\begin{enumerate}
