...
To install the plug-in you will need the following: frama-c 28.0
\begin{enumerate}
...
Since the extension is not published, you can install it locally on your VS Code only.
You will need the following: nvm (node) >= 18.18.0, npm >= 9.8.0, vsce
...
\begin{enumerate}
	...
	\item Run `nvm use 18.18.0', `npm install', `npm run compile' 
