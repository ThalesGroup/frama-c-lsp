...
When client and server are connected, they must agree on which features both can provide through the `initialize' handshake, where the client first sends the features it can support and the server responds with its capabilities.
...
\subsection{Initializing the editor's workspace folder}
